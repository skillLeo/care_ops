...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $permissions = [
            ...
            ['certificate.create', 'Create certificates', 'Generate certificates.'],
            ['certificate.edit', 'Edit certificates', 'Update certificate records.'],
            ['certificate.download', 'Download certificates', 'Download certificate PDFs.'],
        ];
    ...
    public function down(): void
    {
        ...
        PermissionCategory::where('name', 'Certificates')->delete();
    }
};

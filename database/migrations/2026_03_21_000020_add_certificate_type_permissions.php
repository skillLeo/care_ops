...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $category = PermissionCategory::firstOrCreate(
            ...
            ['description' => 'Manage certificate types.', 'created_at' => $now, 'updated_at' => $now]
        );

        $permissions = [
            ['certificate-type.view', 'View certificate types', 'View certificate types.'],
            ['certificate-type.create', 'Create certificate types', 'Create certificate types.'],
            ['certificate-type.edit', 'Edit certificate types', 'Edit certificate types.'],
            ['certificate-type.delete', 'Delete certificate types', 'Delete certificate types.'],
        ];
    ...
    public function down(): void
    {
        ...
        PermissionCategory::where('name', 'Certificate Types')->delete();
    }
};

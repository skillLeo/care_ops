...
return new class extends Migration
{
    ...
    {
        DB::statement(
            "ALTER TABLE client_level_of_cares CHANGE level_of_care level_of_care_old ENUM('PHP','IOP','OP','Hospitalization','Detox') NOT NULL"
        );
        ...
        foreach ($levelMap as $level => $id) {
            DB::table('client_level_of_cares')
    ...
    public function down(): void
    {
        ...
        DB::statement(
            "ALTER TABLE client_level_of_cares CHANGE level_of_care_old level_of_care ENUM('PHP','IOP','OP','Hospitalization','Detox') NOT NULL"
        );
    }
};

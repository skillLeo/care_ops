...
@section('content')
    ...
    <form method="POST" action="{{ route('attendance2026.cprs_group_store') }}" id="cprsGroupForm" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-2">
                <label for="session_type_display">Session Type</label>
        ...
        <div class="row">
            <div class="col-md-12 text-right">
                ...
                <a href="{{ route('attendance2026.cprs_group') }}" class="btn btn-outline-secondary">Clear</a>
            </div>
        </div>
        ...
        <table class="table table-bordered" id="clientTable">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Existing Units</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($clients as $client)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $att?->units ?? 0 }}</td>
                    </tr>
                @empty
                    <tr>
                        <td class="text-center">
    ...
    <script>
        ...
        function applyFilters() {
            ...
            if (!selectedDate || !selectedPeerGroup) {
                alert('Please select service date and peer group before filtering.');
                return;
            }

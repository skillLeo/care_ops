        ...
        <form action="{{ route('roles.update', $role->id) }}" method="POST" id="editRoleForm">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" required pattern="\S+"
                       value="{{ $role->name }}" placeholder="e.g., super_admin" maxlength="50">
            ...
            <div class="form-group">
                ...
                <input type="text" name="display_name" id="display_name" class="form-control" required
                       value="{{ $role->display_name }}" maxlength="50" placeholder="e.g., Super Admin">
                <small class="form-text text-muted">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div id="users" class="checkbox-scroll border rounded p-2">
                            <div class="checkbox-group">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div class="form-check mb-0">
                                        <input
                                            ...
                                            id="user_group_all"
                                        >
                                        <label class="form-check-label" for="user_group_all">
                                            All Users
                                        </label>
                                    </div>
                                    <button type="button" class="btn btn-link btn-sm group-collapse" aria-expanded="false">
                                ...
                                <div class="group-body d-none pl-3">
                                    @foreach($users as $user)
                                        <div class="form-check">
                                            <input
                                                class="form-check-input group-item"
                                                type="checkbox"
                                                name="users[]"
                                                id="user_{{ $user->id }}"
                                                value="{{ $user->id }}"
                                                {{ $role->users->contains($user) ? 'checked' : '' }}
                                            >
                        ...
                        <small class="form-text text-muted">
                            Select or deselect users to assign to this role.
                        </small>
                    </div>
                </div>
            </div>

...
@section('title', 'Add Level of Care')

@section('content_header')
    <h1>Add Level of Care</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('level-of-cares.store') }}" method="POST">
                @csrf

                <div class="form-group">
                    <label for="level_of_care">Level of Care</label>
                    <input type="text" name="level_of_care" id="level_of_care" class="form-control" value="{{ old('level_of_care') }}" required>
                </div>

...
@section('title', 'Reactivation Report')

@section('content_header')
    <h1>Reactivation Report</h1>
@stop

@section('content')
    <form method="GET" action="{{ route('reports.reactivations') }}">
        <div class="row">
    ...
    <table class="table table-bordered" id="clientTable">
        <thead>
            <tr>
                ...
                <th class="text-center">Reactivation Date</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($clients as $client)
                <tr>
                    ...
                    <td class="text-center">{{ \Carbon\Carbon::parse($client->reactivation_date)->format('m/d/Y') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>

...
@section('title', 'Client List by Group')

@section('content_header')
    <h1>Client List by Group</h1>
@stop

@section('content')
    <form method="GET" action="{{ route('reports.clientsByGroup') }}" class="mb-4">
        <div class="row align-items-end">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 mb-3">
                ...
                <select name="group_id" id="group_id" class="form-control">
                    <option value="all" {{ $groupId === 'all' ? 'selected' : '' }}>All</option>
                    <option value="ungrouped" {{ $groupId === 'ungrouped' ? 'selected' : '' }}>Ungrouped</option>
    ...
    <div class="table-responsive">
        <table class="table table-bordered" id="clientsByGroupTable">
            <thead>
                <tr>
                    <th>Group</th>
                    <th>Client</th>
            ...
            <tbody>
                @foreach ($clients as $client)
                    <tr>
                        <td>{{ $client->getClientGroupOnDate($selectedDate)?->name ?? 'Ungrouped' }}</td>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const table = $('#clientsByGroupTable').DataTable({
                dom: 'Blfrtip',
                order: [[0, 'asc'], [1, 'asc']],
                buttons: [{
                    extend: 'pdfHtml5',
                    ...
                    customize: function(doc) {
                        ...
                        // ===== HEADER (DATE LEFT, PAGE NUMBER RIGHT) =====
                        doc.header = function (currentPage, pageCount) {
                            return {
                                ...
                                columns: [
                                    ...
                                    {
                                        stack: [
                                            { text: `Attendance Sheet - ${formattedDate}`, alignment: 'center', fontSize: 12, bold: true }
                                        ],
                                        alignment: 'center'
                                    },
                        ...
                        dataRows.forEach(row => {
                            ...
                            return {
                                ...
                                alignment: colIndex === 0 ? 'left' : 'center', // Client column left

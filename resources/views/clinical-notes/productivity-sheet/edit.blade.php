                        ...
                        <tbody>
                            @foreach ($noteRows as $index => $row)
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="rows[{{ $index }}][note_type]" required>
                                            @foreach (($noteTypeOptions ?? collect()) as $noteType)
                                                <option value="{{ $noteType }}" {{ old("rows.$index.note_type", $row->note_type) === $noteType ? 'selected' : '' }}>
                                                    {{ $noteType }}
                                                </option>
                                            @endforeach
                                        </select>
